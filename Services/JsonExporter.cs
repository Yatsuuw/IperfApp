...
/// Centralise l'instance <see cref="JsonSerializerOptions"/> pour éviter les réallocations.
/// </summary>
public static class JsonExporter
{
    /// <summary>Options communes : indentation activée, instance réutilisable.</summary>
